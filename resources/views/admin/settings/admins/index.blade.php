...
@section('content')
  <div class="section title-section">
    <div class="section d-flex align-items-center">
      <h1><span class="icon"><i class="fas fa-users"></i></span>@lang('message.pages.settings.admins.title')</h1>

      <a href="{{ route('admin.settings.admins.create') }}" class="button button-primary button-rounded ml-auto mr-3" title="@lang('message.pages.settings.admins.new')">@lang('message.pages.settings.admins.new')</a>
