...
@section('head')
  <title>{{ config('app.name') }} :: @lang('message.pages.settings.roles.edit')</title>
@endsection

@section('content')
  <div class="section title-section">
    <div class="section d-flex align-items-center">
      <h1><span class="icon"><i class="fab fa-keycdn"></i></span>@lang('message.pages.settings.roles.edit')</h1>
    </div>
  </div>

  <div class="section data-section">
    <form action="{{ route('admin.settings.roles.edit', $role->slug) }}" method="POST" class="form-default">
      @csrf
